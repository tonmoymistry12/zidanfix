...
const FirstPage = () => {
  ...
  const images = [
    ...
    { imageName: 'Air Cooler Repair & Service', imageUrl: '/images/jobs/aircoler.svg' },
    { imageName: 'Chimney Repair & Service', imageUrl: '/images/jobs/chimney.svg' },
    { imageName: 'Gas Stove Repair & Service', imageUrl: '/images/jobs/gas-stove.svg' },
    ...
    { imageName: 'Mixer & Grinder Repair', imageUrl: '/images/jobs/grinder.svg' },
  ...
  return (
    <div className={style.wrapper}>
      <Grid container sx={{ width: '100%', height: '100%' }}>
        ...
        <Grid item xs={12} md={6} className={style.leftPart}>
        ...
        <Grid item xs={12} md={6} className={style.rightPart}>
